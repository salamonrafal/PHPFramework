...
class com_salamon_settings implements com_salamon_interface_settings
{
	 ...
	 */
	 ...
	 /**
	  * @see com_salamon_interface_settings::setModule()
	  */
	 ...
	 /**
	  * @see com_salamon_interface_settings::getModule()
	  */
	 ...
	 public function loadEnvSetting()
	 {
	 	foreach ($this -> _env as $envName => $domain)
	 	{
	 		if ($_SERVER['SERVER_NAME'] == $domain)
	 		{
	 			...
	 			$path = $this -> getPathToSetting() . ( $this -> getModule() != '' ? $this -> getModule() . '/' : '' ) . $this -> getSettingFileName();
